...
const $$Pasterizacija = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Pasterizacija;
  const {
    title = "Pasterizacija",
  ...
  return renderTemplate`${renderComponent($$result, "SubPageLayoutWithBase", $$SubPageLayoutWithBase, { "chapterNumber": 2, "chapterNumber": 2, "title": title, "description": description, "chapterNumber": 2, "primaryColor": "blue", "breadcrumbPath": [
    { name: "Pasterizacija", url: "/poglavlje-2/pasterizacija/" }
...
</p> </div> </div> </div> </div> </div> </div> </main> </div>  <div class="flex justify-between mt-16 mb-8 max-w-4xl mx-auto px-4 sm:px-6"> <!-- Prethodna stranica --> <a href="/poglavlje-2/suha-sterilizacija/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na prethodnu stranicu: suha sterilizacija">
←
<span class="text-lg">suha sterilizacija</span> </a> <!-- Iduća stranica --> <a href="/poglavlje-2/kuhanje/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na sljedeću stranicu: kuhanje"> <span class="text-lg">kuhanje</span>
→
</a> </div> ` })} ${renderScript($$result, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/pasterizacija.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/pasterizacija.astro", void 0);

const $$file = "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/pasterizacija.astro";
const $$url = "/poglavlje-2/pasterizacija";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$Pasterizacija,
  file: $$file,
  url: $$url
