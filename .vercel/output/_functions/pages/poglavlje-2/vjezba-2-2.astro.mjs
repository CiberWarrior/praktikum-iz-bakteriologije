...
const $$Vjezba22 = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Vjezba22;
  const {
  ...
  return renderTemplate`${renderComponent($$result, "SubPageLayoutWithBase", $$SubPageLayoutWithBase, { "chapterNumber": 2, "chapterNumber": 2, "title": title, "description": description, "chapterNumber": 2, "primaryColor": "blue", "breadcrumbPath": [
    { name: "Vje\u017Eba 2.2 - Ispitati u\u010Dinak dezinficijensa na bakterije", url: "/poglavlje-2/vjezba-2-2/" }
...
</p> </div> </div> </div> </div> </div> </main> </div>  <div class="flex justify-between mt-16 mb-8 max-w-4xl mx-auto px-4 sm:px-6"> <!-- Prethodna stranica --> <a href="/poglavlje-2/vjezba-2-1/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na prethodnu stranicu: vježba 2.1">
←
<span class="text-lg">vježba 2.1</span> </a> <!-- Iduća stranica --> <a href="/poglavlje-2/vjezba-2-3/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na sljedeću stranicu: vježba 2.3"> <span class="text-lg">vježba 2.3</span>
→
</a> </div> ` })} ${renderScript($$result, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/vjezba-2-2.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/vjezba-2-2.astro", void 0);

const $$file = "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/vjezba-2-2.astro";
const $$url = "/poglavlje-2/vjezba-2-2";
