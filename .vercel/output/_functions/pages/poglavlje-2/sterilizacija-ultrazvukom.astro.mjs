...
const $$SterilizacijaUltrazvukom = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$SterilizacijaUltrazvukom;
  const {
  ...
  return renderTemplate`${renderComponent($$result, "SubPageLayoutWithBase", $$SubPageLayoutWithBase, { "chapterNumber": 2, "chapterNumber": 2, "title": title, "description": description, "chapterNumber": 2, "primaryColor": "blue", "breadcrumbPath": [
    { name: "Sterilizacija ultrazvukom", url: "/poglavlje-2/sterilizacija-ultrazvukom/" }
...
</p> </div> </div> </div> </div> </div> </div> </main> </div>  <div class="flex justify-between mt-16 mb-8 max-w-4xl mx-auto px-4 sm:px-6"> <!-- Prethodna stranica --> <a href="/poglavlje-2/sterilizacija-zracenjem/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na prethodnu stranicu: sterilizacija zračenjem">
←
<span class="text-lg">sterilizacija zračenjem</span> </a> <!-- Iduća stranica --> <a href="/poglavlje-2/hladna-sterilizacija/" class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 no-underline transform hover:-translate-y-1" aria-label="Prijeđi na sljedeću stranicu: hladna sterilizacija ili membranska filtracija"> <span class="text-lg">hladna sterilizacija ili membranska filtracija</span>
→
</a> </div> ` })} ${renderScript($$result, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/sterilizacija-ultrazvukom.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/sterilizacija-ultrazvukom.astro", void 0);

const $$file = "/Users/renchi/Desktop/praktikum-iz-bakteriologije/src/pages/poglavlje-2/sterilizacija-ultrazvukom.astro";
const $$url = "/poglavlje-2/sterilizacija-ultrazvukom";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$SterilizacijaUltrazvukom,
  file: $$file,
  url: $$url
