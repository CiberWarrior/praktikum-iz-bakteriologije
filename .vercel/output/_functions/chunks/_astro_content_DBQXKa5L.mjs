...
import { A as AstroError, G as GetEntryDeprecationError, x as UnknownContentCollectionError, a as createComponent, y as renderUniqueStylesheet, z as renderScriptElement, B as createHeadAndContent, e as renderComponent, d as renderTemplate, u as unescapeHTML, C as RenderUndefinedEntryError } from './astro/server_B-kAR108.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_eSUblbIm.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_6X6TObP6.mjs').then(n => n._);
